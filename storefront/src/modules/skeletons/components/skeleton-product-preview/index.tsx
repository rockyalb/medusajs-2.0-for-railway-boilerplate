const SkeletonProductPreview = () => {
  return (
    <div className="animate-pulse overflow-hidden rounded-large border border-white/60 bg-white/60 backdrop-blur-[6px]">
      <div className="aspect-[4/5] w-full bg-yco-panel small:aspect-[3/4]" />
      <div className="space-y-2 border-t border-yco-cream-dark px-3 pb-3 pt-3 small:px-4 small:pb-4">
