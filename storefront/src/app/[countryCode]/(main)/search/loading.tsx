export default function SearchLoading() {
  return (
    <div className="relative z-[75]">
      <div className="fixed inset-0 h-screen w-screen bg-yco-charcoal/20 backdrop-blur-xl" />
      <div className="fixed inset-0 px-3 py-3 sm:p-6">
        <div className="flex h-full w-full items-start justify-center">
          <div className="flex h-[calc(100vh-1.5rem)] w-full flex-col overflow-hidden rounded-large border border-yco-cream-dark bg-white shadow-[0_32px_80px_-34px_rgba(47,45,41,0.7)] sm:h-[32rem] sm:w-[min(56rem,calc(100vw-3rem))]">
            ...
            <div className="grid flex-1 content-start gap-3 px-4 py-4 sm:grid-cols-3 sm:px-5 sm:py-5">
              {[0, 1, 2, 3, 4, 5].map((item) => (
                <div
                  key={item}
                  className="flex items-center gap-3 rounded-large border border-yco-cream-dark bg-yco-panel p-2.5 sm:flex-col sm:items-stretch sm:p-3"
                >
